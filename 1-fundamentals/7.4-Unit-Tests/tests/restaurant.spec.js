...
describe('10 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    test5.order('coxinha');
    expect(test5.consumption[0]).toBe('coxinha');
    ...
    test6.order('sopa');
    test6.order('sashimi');
    expect(test6.consumption).toEqual(expect.arrayContaining(['coxinha', 'agua', 'sopa', 'sashimi']));
    ...
    test7.order('agua');
    test7.order('coxinha');
    expect(test7.consumption).toEqual(expect.arrayContaining(['coxinha', 'agua', 'coxinha']));
    ...
    // ```
    const test8 = createMenu({ food: {coxinha: 4.50, sashimi: 12, sopa:17.90}, drink: {agua: 3.50, cafe: 7.50, guarana: 6.50} });
    test8.order('coxinha');
    test8.order('sashimi');
    test8.order('sopa');
    test8.order('agua');
    test8.order('cafe');
    test8.order('guarana');
    expect(test8.pay()).toBeCloseTo(51.9);
