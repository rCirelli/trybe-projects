...
1. Clone o repositório
  * `git clone git@github.com:tryber/sd-021-b-project-meme-generator.git`.
  * Entre na pasta do repositório que você acabou de clonar:
    * `cd sd-021-b-project-meme-generator`
...
4. Crie na raiz do projeto os arquivos que você precisará desenvolver:
  * Verifique que você está na raiz do projeto
    * Exemplo: `pwd` -> o retorno vai ser algo tipo _/Users/joaozinho/code/**sd-021-b-project-meme-generator**_
...
7. Crie um novo `Pull Request` _(PR)_
  * Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-021-b-project-meme-generator/pulls)
